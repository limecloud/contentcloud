...
func scanTaskStageOutput(row pgx.Row) (work.TaskStageOutput, error) {
	var value work.TaskStageOutput
	var metadata []byte
...
func insertTaskStageOutput(ctx context.Context, tx pgx.Tx, value work.TaskStageOutput) error {
	value.NormalizeCollections()
...
func (s *Store) CompleteStageRun(ctx context.Context, run work.StageRun, outputs []work.TaskStageOutput) error {
...
func taskStageOutputsTx(ctx context.Context, tx pgx.Tx, tenantID, taskID string) ([]work.TaskStageOutput, error) {
...
func (s *Store) TaskStageOutputs(ctx context.Context, tenantID, taskID string) ([]work.TaskStageOutput, error) {
	result := []work.TaskStageOutput{}
...
func (s *Store) CreateProviderProfile(ctx context.Context, value deliverydomain.ProviderProfile) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func scanProviderProfile(row pgx.Row) (deliverydomain.ProviderProfile, error) {
	var value deliverydomain.ProviderProfile
...
func (s *Store) ProviderProfile(ctx context.Context, providerID, version string) (deliverydomain.ProviderProfile, error) {
...
func (s *Store) SaveProviderProfile(ctx context.Context, value deliverydomain.ProviderProfile) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) ProviderProfiles(ctx context.Context, providerID string) ([]deliverydomain.ProviderProfile, error) {
...
func (s *Store) SaveProviderBinding(ctx context.Context, value deliverydomain.ProviderBinding) error {
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) ProviderBinding(ctx context.Context, tenantID, providerID string) (deliverydomain.ProviderBinding, error) {
	var result deliverydomain.ProviderBinding
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) CreateMediaGenerationJob(ctx context.Context, value deliverydomain.MediaGenerationJob) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) PendingMediaGenerationJobs(ctx context.Context, limit int) ([]deliverydomain.MediaGenerationJob, error) {
	...
	result := make([]deliverydomain.MediaGenerationJob, 0, len(refs))
...
func (s *Store) MediaGenerationJob(ctx context.Context, tenantID, id string) (deliverydomain.MediaGenerationJob, error) {
	var result deliverydomain.MediaGenerationJob
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) MediaGenerationJobs(ctx context.Context, tenantID, taskID string) ([]deliverydomain.MediaGenerationJob, error) {
...
func (s *Store) SaveMediaGenerationJob(ctx context.Context, value deliverydomain.MediaGenerationJob, expectedVersion int) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
		...
		if !deliverydomain.CanTransitionMediaJob(currentState, value.State) {
...
func (s *Store) CreateProviderAttempt(ctx context.Context, value deliverydomain.ProviderAttempt) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) SaveProviderAttempt(ctx context.Context, value deliverydomain.ProviderAttempt) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) ProviderAttempts(ctx context.Context, tenantID, jobID string) ([]deliverydomain.ProviderAttempt, error) {
...
func (s *Store) ProviderAttemptsByRuntimeJob(ctx context.Context, tenantID, runtimeJobID string) ([]deliverydomain.ProviderAttempt, error) {
	result := []deliverydomain.ProviderAttempt{}
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func scanMediaReview(row pgx.Row) (deliverydomain.MediaReview, error) {
	var value deliverydomain.MediaReview
	var checks []byte
...
func (s *Store) CreateMediaReview(ctx context.Context, value deliverydomain.MediaReview) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) SaveMediaReview(ctx context.Context, value deliverydomain.MediaReview, expectedVersion int) error {
	value.NormalizeCollections()
	if err := value.Validate(); err != nil {
		return err
	}
...
func (s *Store) MediaReview(ctx context.Context, tenantID, id string) (deliverydomain.MediaReview, error) {
	var result deliverydomain.MediaReview
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) MediaReviews(ctx context.Context, tenantID, taskID string) ([]deliverydomain.MediaReview, error) {
