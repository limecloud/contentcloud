...
const deviceDaemonInstancesMigration = "00049_device_daemon_instances.sql"
const runtimeExecutionBindingSnapshotsMigration = "00050_runtime_execution_binding_snapshots.sql"
const runtimeAttemptGatewayTokensMigration = "00051_runtime_attempt_gateway_tokens.sql"
const desktopWorkspaceRevisionsMigration = "00052_desktop_workspace_revisions.sql"
