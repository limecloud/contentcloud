...
func scanResourceQuota(row pgx.Row) (contentruntime.ResourceQuota, error) {
	var value contentruntime.ResourceQuota
...
func scanResourceReservation(row pgx.Row) (contentruntime.ResourceReservation, error) {
	var value contentruntime.ResourceReservation
...
func (s *Store) SaveResourceQuota(ctx context.Context, quota contentruntime.ResourceQuota) error {
...
func (s *Store) ResourceQuotas(ctx context.Context, tenantID string) ([]contentruntime.ResourceQuota, error) {
...
func (s *Store) ResourceReservations(ctx context.Context, tenantID, jobID string) ([]contentruntime.ResourceReservation, error) {
...
func reserveResourcesTx(ctx context.Context, tx pgx.Tx, reservations []contentruntime.ResourceReservation) error {
