...
func (s *Store) CreateSource(ctx context.Context, source sourcedomain.Source, revision sourcedomain.SourceRevision) error {
...
func (s *Store) CreateSourceRevision(ctx context.Context, revision sourcedomain.SourceRevision) error {
...
func (s *Store) Sources(ctx context.Context, tenantID, projectID string) ([]sourcedomain.Source, error) {
...
func (s *Store) Source(ctx context.Context, tenantID, id string) (sourcedomain.Source, error) {
	var v sourcedomain.Source
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) SourceRevisions(ctx context.Context, tenantID, sourceID string) ([]sourcedomain.SourceRevision, error) {
...
func scanRevision(row pgx.Row) (sourcedomain.SourceRevision, error) {
	var v sourcedomain.SourceRevision
...
func (s *Store) SourceRevision(ctx context.Context, tenantID, id string) (sourcedomain.SourceRevision, error) {
...
func (s *Store) SaveSourceRevision(ctx context.Context, v sourcedomain.SourceRevision) error {
...
func (s *Store) PendingSourceRevisions(ctx context.Context, limit int) ([]sourcedomain.SourceRevision, error) {
...
func (s *Store) ClaimSourceRevision(ctx context.Context, tenantID, id string) (sourcedomain.SourceRevision, bool, error) {
	var result sourcedomain.SourceRevision
	claimed := false
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) CreateEvidence(ctx context.Context, v sourcedomain.EvidenceSpan) error {
	return s.withTenant(ctx, v.TenantID, func(tx pgx.Tx) error {
...
func (s *Store) Evidence(ctx context.Context, tenantID, revisionID string) ([]sourcedomain.EvidenceSpan, error) {
	...
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
		...
		defer rows.Close()
		for rows.Next() {
			var v sourcedomain.EvidenceSpan
			var locator []byte
...
func (s *Store) EvidenceSpan(ctx context.Context, tenantID, id string) (sourcedomain.EvidenceSpan, error) {
...
func (s *Store) SaveEvidence(ctx context.Context, v sourcedomain.EvidenceSpan) error {
	return s.withTenant(ctx, v.TenantID, func(tx pgx.Tx) error {
