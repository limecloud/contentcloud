...
func (s *Store) CreateDeliveryPackage(ctx context.Context, value deliverydomain.DeliveryPackage, artifacts []deliverydomain.Artifact) error {
...
func (s *Store) DeliveryPackage(ctx context.Context, tenantID, id string) (deliverydomain.DeliveryPackage, error) {
	var value deliverydomain.DeliveryPackage
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func loadDeliveryPackageRelations(ctx context.Context, tx pgx.Tx, value *deliverydomain.DeliveryPackage) error {
	...
	value.Manifest = []deliverydomain.Artifact{}
