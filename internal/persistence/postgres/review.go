...
func (s *Store) CreateReviewCycle(ctx context.Context, cycle reviewdomain.ReviewCycle) (reviewdomain.ReviewCycle, error) {
	err := s.withTenant(ctx, cycle.TenantID, func(tx pgx.Tx) error {
		...
		if cycle.SubjectType != "submission_revision" {
			return fault.Invalid("REVIEW_SUBJECT_TYPE_INVALID", "审核周期不支持该主题类型（subject_type）")
		}
...
func scanReviewCycle(row pgx.Row) (reviewdomain.ReviewCycle, error) {
...
func (s *Store) ReviewCycles(ctx context.Context, tenantID, subjectID string) ([]reviewdomain.ReviewCycle, error) {
...
func (s *Store) SaveReviewCycle(ctx context.Context, cycle reviewdomain.ReviewCycle) error {
...
func (s *Store) CreateReviewComment(ctx context.Context, v reviewdomain.ReviewComment) error {
...
func scanReviewComment(row pgx.Row) (reviewdomain.ReviewComment, error) {
	var v reviewdomain.ReviewComment
...
func (s *Store) ReviewComments(ctx context.Context, tenantID, subjectID string) ([]reviewdomain.ReviewComment, error) {
...
func (s *Store) ReviewComment(ctx context.Context, tenantID, id string) (reviewdomain.ReviewComment, error) {
	var result reviewdomain.ReviewComment
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) SaveReviewComment(ctx context.Context, v reviewdomain.ReviewComment) error {
	return s.withTenant(ctx, v.TenantID, func(tx pgx.Tx) error {
...
func (s *Store) CreateReviewGrant(ctx context.Context, v reviewdomain.ReviewGrant) error {
	return s.withTenant(ctx, v.TenantID, func(tx pgx.Tx) error {
...
func scanReviewGrant(row pgx.Row) (reviewdomain.ReviewGrant, error) {
	var v reviewdomain.ReviewGrant
...
func (s *Store) ReviewGrant(ctx context.Context, tenantID, id string) (reviewdomain.ReviewGrant, error) {
...
func (s *Store) ReviewGrants(ctx context.Context, tenantID, subjectID string) ([]reviewdomain.ReviewGrant, error) {
...
func (s *Store) ReviewGrantByTokenHash(ctx context.Context, hash string) (reviewdomain.ReviewGrant, error) {
...
func insertArtifact(ctx context.Context, tx pgx.Tx, value deliverydomain.Artifact) error {
...
func scanArtifact(row pgx.Row) (deliverydomain.Artifact, error) {
	var v deliverydomain.Artifact
	var metadata []byte
...
func (s *Store) ArtifactsByApprovedSnapshot(ctx context.Context, tenantID, snapshotID string) ([]deliverydomain.Artifact, error) {
...
func (s *Store) Artifact(ctx context.Context, tenantID, id string) (deliverydomain.Artifact, error) {
