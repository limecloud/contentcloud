...
func scanWorkspaceFolder(row pgx.Row) (workspacedomain.WorkspaceFolder, error) {
	var value workspacedomain.WorkspaceFolder
...
func (s *Store) CreateWorkspaceFolder(ctx context.Context, value workspacedomain.WorkspaceFolder) error {
...
func (s *Store) WorkspaceFolders(ctx context.Context, tenantID, projectID string) ([]workspacedomain.WorkspaceFolder, error) {
...
func (s *Store) WorkspaceFolder(ctx context.Context, tenantID, id string) (workspacedomain.WorkspaceFolder, error) {
	var value workspacedomain.WorkspaceFolder
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func scanWorkspaceMaterial(row pgx.Row) (workspacedomain.WorkspaceMaterial, error) {
	var value workspacedomain.WorkspaceMaterial
...
func (s *Store) CreateWorkspaceMaterial(ctx context.Context, value workspacedomain.WorkspaceMaterial) error {
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
...
func (s *Store) WorkspaceMaterials(ctx context.Context, tenantID, projectID string) ([]workspacedomain.WorkspaceMaterial, error) {
...
func (s *Store) WorkspaceMaterial(ctx context.Context, tenantID, id string) (workspacedomain.WorkspaceMaterial, error) {
	var value workspacedomain.WorkspaceMaterial
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) SaveWorkspaceMaterial(ctx context.Context, value workspacedomain.WorkspaceMaterial) error {
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
