...
func scanAsset(row pgx.Row) (sourcedomain.Asset, error) {
	var value sourcedomain.Asset
...
func (s *Store) CreateAsset(ctx context.Context, value sourcedomain.Asset) error {
...
func (s *Store) Assets(ctx context.Context, tenantID, projectID string) ([]sourcedomain.Asset, error) {
...
func (s *Store) Asset(ctx context.Context, tenantID, id string) (sourcedomain.Asset, error) {
...
func (s *Store) SaveAsset(ctx context.Context, value sourcedomain.Asset) error {
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
...
func scanRightsRecord(row pgx.Row) (sourcedomain.RightsRecord, error) {
	var value sourcedomain.RightsRecord
...
func (s *Store) CreateRightsRecord(ctx context.Context, value sourcedomain.RightsRecord) error {
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
...
func (s *Store) RightsRecords(ctx context.Context, tenantID, assetID string) ([]sourcedomain.RightsRecord, error) {
...
func (s *Store) RightsRecord(ctx context.Context, tenantID, id string) (sourcedomain.RightsRecord, error) {
...
func (s *Store) SaveRightsRecord(ctx context.Context, value sourcedomain.RightsRecord) error {
	return s.withTenant(ctx, value.TenantID, func(tx pgx.Tx) error {
