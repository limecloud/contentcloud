...
var builtins = []definition{
	{
		ID:                   domain.KnowledgeExtractCapability,
		Version:              "1.0.0",
...
func Builtins(releaseVersion string) []domain.Capability {
	result := make([]domain.Capability, 0, len(builtins))
...
func Exact(id, releaseVersion string) (domain.Capability, bool) {
...
func Digest(capability domain.Capability, releaseVersion string) string {
