...
func TestEnvironmentPreparationFailureRollsBackOnlyTheNewPack(t *testing.T) {
	...
	missingPack := `{"installed":[{"pluginId":"contentcloud-video-production@contentcloud","name":"contentcloud-video-production","marketplaceName":"contentcloud","version":"0.17.0","installed":true,"enabled":true}],"available":[]}`
