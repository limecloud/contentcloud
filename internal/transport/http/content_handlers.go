...
func (s *Server) revokeDevice(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Workspace.RevokeDevice(r.Context(), actor, chi.URLParam(r, "id"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) rotateDeviceCredential(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	value, err := s.service.Workspace.RotateDeviceCredential(r.Context(), actor, chi.URLParam(r, "id"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) device(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Workspace.Device(r.Context(), actor, chi.URLParam(r, "id"))
	if err != nil {
...
func (s *Server) attachDevice(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Workspace.AttachDevice(r.Context(), actor, chi.URLParam(r, "id"), chi.URLParam(r, "projectID"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) detachDevice(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Workspace.DetachDevice(r.Context(), actor, chi.URLParam(r, "id"), chi.URLParam(r, "projectID"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) approveDeviceAuth(w http.ResponseWriter, r *http.Request) {
	...
	v, err := s.service.Identity.ApproveUserDeviceLogin(r.Context(), actor, in.UserCode)
	if err != nil {
...
func (s *Server) cancelRun(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Runtime.CancelRun(r.Context(), actor, chi.URLParam(r, "id"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) resolveReviewComment(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Review.ResolveReviewComment(r.Context(), actor, chi.URLParam(r, "id"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) createReviewGrant(w http.ResponseWriter, r *http.Request) {
	...
	v, err := s.service.Review.CreateReviewGrant(r.Context(), actor, chi.URLParam(r, "id"), in.ReviewerEmail, middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) reviewGrants(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Review.ReviewGrants(r.Context(), actor, chi.URLParam(r, "id"))
	if err != nil {
...
func (s *Server) revokeReviewGrant(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	v, err := s.service.Review.RevokeReviewGrant(r.Context(), actor, chi.URLParam(r, "id"), middleware.GetReqID(r.Context()))
	if err != nil {
...
func (s *Server) approvedSnapshotArtifacts(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	value, err := s.service.Review.ApprovedSnapshotArtifacts(r.Context(), actor, chi.URLParam(r, "id"))
	if err != nil {
...
func (s *Server) deliveryPackages(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	value, err := s.service.Review.DeliveryPackages(r.Context(), actor, chi.URLParam(r, "projectID"))
	if err != nil {
...
func (s *Server) deliveryPackage(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	value, err := s.service.Review.DeliveryPackage(r.Context(), actor, chi.URLParam(r, "id"))
	if err != nil {
...
func (s *Server) downloadArtifact(w http.ResponseWriter, r *http.Request) {
	actor, _ := auth(r)
	artifact, data, err := s.service.Review.ArtifactBytes(r.Context(), actor, chi.URLParam(r, "id"))
	if err != nil {
...
func (s *Server) publicReviewProjection(w http.ResponseWriter, r *http.Request) {
	v, err := s.service.Review.ReviewProjection(r.Context(), chi.URLParam(r, "token"))
	if err != nil {
...
func (s *Server) publicReviewVerify(w http.ResponseWriter, r *http.Request) {
	...
	v, err := s.service.Review.VerifyReviewGrant(r.Context(), chi.URLParam(r, "token"), in.OTP)
	if err != nil {
...
func (s *Server) publicReviewDecision(w http.ResponseWriter, r *http.Request) {
	...
	v, err := s.service.Review.DecideReviewGrant(r.Context(), chi.URLParam(r, "token"), in.Decision, in.Reason, in.ShotID, middleware.GetReqID(r.Context()))
	if err != nil {
