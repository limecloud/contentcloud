...
func (r *Root) auditCommand() *cobra.Command {
	...
	list := &cobra.Command{Use: "list", Short: "列出项目审计事件", RunE: func(cmd *cobra.Command, _ []string) error {
		...
		var result []auditdomain.AuditEvent
