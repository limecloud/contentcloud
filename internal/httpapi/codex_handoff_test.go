...
func assertProjectCodexHandoff(t *testing.T, handoff codexHandoffResponse, projectID string) {
	...
	if handoff.PluginID != "contentcloud-video-production" || handoff.PluginVersion != "0.21.0" || !handoff.RequiresNewChat || !handoff.RequiresWorkspaceSelection || handoff.FallbackURL != "/codex" || len(handoff.Steps) != 3 {
