...
func assertProjectCodexHandoff(t *testing.T, handoff codexHandoffResponse, projectID string) {
	...
	if handoff.PluginID != "contentcloud-video-production@contentcloud" || handoff.PluginVersion != "0.9.0" || !handoff.RequiresNewChat || !handoff.RequiresWorkspaceSelection || handoff.FallbackURL != "/codex" || len(handoff.Steps) != 3 {
