...
func TestEnvironmentStateStoresAndVerifiesSignedManifestAndExactLock(t *testing.T) {
	...
	installed := []environment.LockedPlugin{{ID: "contentcloud-video-production", Kind: "scene_plugin", Version: "0.5.0", Digest: "sha256:" + strings.Repeat("a", 64), Installed: true}}
...
func workspaceEnvironmentFixture(t *testing.T, now time.Time) (environment.Manifest, *environment.Verifier, environment.Registry, *environment.RegistryVerifier) {
	...
	registry := environment.Registry{SchemaVersion: "1.0", Entries: []environment.RegistryEntry{{
		ID: "contentcloud-video-production", Kind: "scene_plugin", Version: "0.5.0", Source: environment.RegistrySource{Repository: "https://github.com/limecloud/contentcloud", Ref: "v0.5.0"}, License: "Apache-2.0", Digest: "sha256:" + strings.Repeat("a", 64),
