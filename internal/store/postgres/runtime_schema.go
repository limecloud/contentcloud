...
func scanRuntimeSchema(row pgx.Row) (domain.RuntimeSchema, error) {
	var schema domain.RuntimeSchema
	var definition []byte
...
func (s *Store) CreateRuntimeSchema(ctx context.Context, schema domain.RuntimeSchema) error {
...
func (s *Store) RuntimeSchema(ctx context.Context, tenantID, schemaID string, revision int) (domain.RuntimeSchema, error) {
	var result domain.RuntimeSchema
...
func (s *Store) RuntimeSchemas(ctx context.Context, tenantID, schemaID string) ([]domain.RuntimeSchema, error) {
	result := []domain.RuntimeSchema{}
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
...
func (s *Store) PublishRuntimeSchema(ctx context.Context, next domain.RuntimeSchema, expectedVersion int) (domain.RuntimeSchema, error) {
	return s.transitionRuntimeSchema(ctx, next, expectedVersion, "draft", "published")
}

func (s *Store) RetireRuntimeSchema(ctx context.Context, next domain.RuntimeSchema, expectedVersion int) (domain.RuntimeSchema, error) {
	return s.transitionRuntimeSchema(ctx, next, expectedVersion, "published", "retired")
}

func (s *Store) transitionRuntimeSchema(ctx context.Context, next domain.RuntimeSchema, expectedVersion int, expectedStatus, nextStatus string) (domain.RuntimeSchema, error) {
