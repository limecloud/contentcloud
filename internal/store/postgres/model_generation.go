...
func (s *Store) CreateModelGenerationReceipt(ctx context.Context, value domain.ModelGenerationReceipt) error {
...
func (s *Store) CreateModelGeneratedRevision(ctx context.Context, revision domain.TaskRevision, receipt domain.ModelGenerationReceipt) error {
...
func (s *Store) ModelGenerationReceipts(ctx context.Context, tenantID, taskID string) ([]domain.ModelGenerationReceipt, error) {
	...
	err := s.withTenant(ctx, tenantID, func(tx pgx.Tx) error {
		...
		defer rows.Close()
		for rows.Next() {
			var value domain.ModelGenerationReceipt
