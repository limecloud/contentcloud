...
func TestValidateV3MigrationSet(t *testing.T) {
	available := []string{v3BaselineMigration, v5SubmissionTypesMigration, tenantContentCapabilitiesMigration, runProgressEventsMigration}
	for _, applied := range [][]string{nil, {v3BaselineMigration}, {v3BaselineMigration, v5SubmissionTypesMigration}, {v3BaselineMigration, v5SubmissionTypesMigration, tenantContentCapabilitiesMigration}, available} {
...
func TestValidateV3MigrationSetRejectsLegacyHistory(t *testing.T) {
	err := validateV3MigrationSet([]string{v3BaselineMigration, v5SubmissionTypesMigration, tenantContentCapabilitiesMigration, runProgressEventsMigration}, []string{"00001_core.sql"})
...
func TestValidateV3MigrationSetRejectsV5WithoutBaseline(t *testing.T) {
	err := validateV3MigrationSet([]string{v3BaselineMigration, v5SubmissionTypesMigration, tenantContentCapabilitiesMigration, runProgressEventsMigration}, []string{v5SubmissionTypesMigration})
...
func TestValidateV3MigrationSetRejectsTenantCapabilitiesWithoutV5(t *testing.T) {
	err := validateV3MigrationSet([]string{v3BaselineMigration, v5SubmissionTypesMigration, tenantContentCapabilitiesMigration, runProgressEventsMigration}, []string{v3BaselineMigration, tenantContentCapabilitiesMigration})
	if err == nil || !strings.Contains(err.Error(), "migration 历史无效") {
