...
type Store struct {
	...
	channelBindings           map[string]domain.ChannelBinding
	channelPublications       map[string]domain.ChannelPublication
	channelCallbackReceipts   map[string]domain.ChannelCallbackReceipt
	modelGenerationReceipts   map[string]domain.ModelGenerationReceipt
