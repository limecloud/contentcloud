import { Archive, BookOpen, ChevronDown, ClipboardCheck, LayoutDashboard, ListTodo, LogOut, Menu, MonitorUp, PackageCheck, Sparkles, X } from 'lucide-react';
