...
export function AuthLayout({children, footer}: PropsWithChildren<{footer?: ReactNode}>) {
  return (
    <main className="auth-shell">
      <section className="auth-scene"><div className="auth-scene-copy"><span>CONTENT WORK OS</span><h1>让内容工作，<br/>自然流转</h1><p>资料和已有资产进入清晰的创作流水线，团队在关键节点确认，并持续复用每次成果。</p></div></section>
