const statusLabels: Record<string, string> = {
  accepted: '已接受', accepted_risk: '已接受风险', active: '运行中', approved: '已确认', archived: '已归档', online: '在线', offline: '离线', unknown: '未知',
  awaiting_cost_approval: '待确认费用', blocked: '暂时无法继续', canceled: '已取消', cancelled: '已取消', cancelled_job: '已取消',
  candidate: '待确认', changes_requested: '待修改', client_review: '客户审核中', collecting: '补充资料中', complete: '完整',
  completed: '已完成', conflicted: '有冲突', connected: '已接入', delivered: '已交付', deprecated: '已弃用', discarded: '不采用',
  consumed: '已使用', denied: '已拒绝', downloading: '下载中', draft: '草稿', empty: '暂无记录', expired: '已过期', failed: '失败', generating: '生成中',
  evaluated: '已评测', imported: '已导入', in_review: '审核中', insufficient_sample: '样本不足', internal_review: '内部审核中',
  internally_approved: '内部已确认', leased: '执行中', legacy_incomplete: '历史数据不完整', needs_info: '待补信息',
  ...
  script_only: '仅剧本', security_review: '安全审核中', source_missing: '缺少来源', submitted: '已提交', submitting: '提交中', succeeded: '已完成', superseded: '已替代',
  suspended: '已停用', planned: '即将支持', healthy: '健康', unhealthy: '不可用', degraded: '降级', throttled: '受限', unavailable: '不可用', task_created: '已创建任务', task_merged: '已并入任务', untriaged: '待分流', valid: '有效',
  validated: '已核验', validating: '校验中', verified: '已核验', verifying: '接入初始化中',
  waiting_for_computer: '等待工作电脑', waiting_gate: '待确认', waived: '已豁免'
};

const roleLabels: Record<string, string> = {
  tenant_admin: '团队管理员', project_manager: '项目负责人', strategist: '内容策划', editor: '内容编辑', reviewer: '内容审核',
  viewer: '查看成员', client_approver: '客户确认人', workspace: '项目文件夹', agent: '自动处理'
};
...
const knowledgeObjectTypeLabels: Record<string, string> = {
  ...
  ConflictRecord: '冲突记录', ConstraintRecord: '约束记录', DomainObject: '业务信息', FactAssertion: '事实陈述',
  Insight: '业务洞察', KnowledgeGap: '还缺少的内容', Learning: '复盘结论', Process: '业务流程',
  RightsRecord: '权利记录', Scenario: '使用场景', knowledge_object: '知识内容'
};
...
const sourceTypeLabels: Record<string, string> = {
  brief: '创作简报', manual_inspiration: '人工灵感', workspace_file: '项目文件', comment: '审核评论', external_request: '外部需求',
...
const deliveryDestinationLabels: Record<string, string> = {
  workspace: '项目文件夹', download: '浏览器下载', client: '客户交付区'
};
...
const auditActionLabels: Record<string, string> = {
  sop_version_published: '发布流程版本', sop_version_updated: '更新流程版本', environment_updated: '更新客户设置',
  task_stage_reported: '更新任务进度', knowledge_decision: '完成内容审核',
  'approved_snapshot.exported': '导出已确认版本', 'asset.created': '创建素材',
  'bootstrap.authorization.approved': '确认电脑连接', 'bootstrap.authorization.denied': '拒绝电脑连接',
  'bootstrap.diagnostic.uploaded': '上传连接检查信息', 'cli_login.approved': '确认电脑登录',
  'cli_token.tenant_switched': '切换客户账号', 'connect_session.canceled': '取消电脑连接',
  'connect_session.created': '连接电脑', 'conversation_import.cancelled': '取消对话导入',
  ...
  'device.revoked': '撤销本地设备', 'environment.created': '新增客户设置', 'environment.updated': '更新客户设置',
  'evidence.reviewed': '核对原文依据', 'gate.created': '创建检查与确认记录', 'gate.decided': '完成检查与确认',
  ...
  'knowledge_object.created': '创建知识内容', 'knowledge_object.decided': '完成知识审核',
  'knowledge_pack.created': '创建内容合集', 'knowledge_pack.published': '发布内容合集',
  ...
  'performance_import.created': '导入投放表现数据', 'platform.tenant_content_capability_changed': '更新客户可用功能',
  'platform.tenant_status_changed': '更新客户状态', 'project.archived': '归档项目', 'project.created': '创建项目',
  'project.restored': '恢复项目', 'project.sop_bound': '设置项目创作流程', 'project.updated': '更新项目',
  ...
  'run.attempt_canceled': '取消执行尝试', 'run.cancel_requested': '请求取消执行任务', 'session.tenant_switched': '切换当前客户',
  'sop.created': '创建创作流程', 'sop.version_created': '创建创作流程草稿', 'sop.version_published': '发布创作流程',
  'sop.version_retired': '停用创作流程版本', 'sop.version_rolled_back': '恢复旧版创作流程', 'sop.version_saved': '保存创作流程草稿',
  ...
  'tenant.created': '创建客户账号', 'workspace.registered': '登记项目文件夹'
};
...
const auditSubjectLabels: Record<string, string> = {
  ...
  cli_token: '电脑登录凭证', connect_session: '电脑连接', conversation_import: '对话导入', delivery_package: '交付包',
  device: '本地设备', environment: '客户设置', evidence_span: '原文片段', gate_evaluation: '检查与确认记录',
  input_item: '输入记录', knowledge_object: '知识内容', knowledge_pack: '可用内容合集', media_generation_job: '视频生成任务',
  media_review: '媒体审核', membership: '成员关系', membership_invite: '成员邀请', performance_import_batch: '表现数据导入批次',
  project: '项目', project_sop_binding: '项目创作流程设置', project_template: '项目模板', rating_decision: '表现评级',
  review_comment: '审核评论', review_grant: '外部审核授权', rights_record: '素材权利记录', run_attempt: '任务处理记录',
  session: '登录会话', sop: '创作流程', sop_version: '创作流程版本', source: '来源', source_revision: '来源版本',
  stage_run: '创作步骤记录', submission_revision: '提交内容版本', task: '任务', task_delivery: '任务交付',
	 task_revision: '任务内容版本', runtime_run: '任务处理', tenant: '客户账号', user_device_flow: '电脑登录授权',
  workspace_binding: '项目电脑连接'
};

export function statusLabel(value: string): string { return statusLabels[value] || '当前状态'; }
export function roleLabel(value: string): string { return roleLabels[value] || '团队成员'; }
export function contentTypeLabel(value: string): string { return contentTypeLabels[value] || '其他内容'; }
export function submissionTypeLabel(value: string): string { return submissionTypeLabels[value] || '内容记录'; }
export function knowledgeObjectTypeLabel(value: string): string { return knowledgeObjectTypeLabels[value] || '知识内容'; }
...
export function knowledgeLayerLabel(value: string): string { return knowledgeLayerLabels[value] || '其他知识分类'; }
export function sourceTypeLabel(value: string): string { return sourceTypeLabels[value] || '其他来源'; }
export function evidenceLocatorLabel(value: string): string { return evidenceLocatorLabels[value] || '原文位置'; }
export function stageLabel(value: string): string { return stageLabels[value] || '其他步骤'; }
export function gateModeLabel(value: string): string { return gateModeLabels[value] || '其他确认方式'; }
export function outputRoleLabel(value: string): string { return outputRoleLabels[value] || '其他输出'; }
export function artifactKindLabel(value: string): string { return artifactKindLabels[value] || '其他成果'; }
...
export function knowledgeBlockReasonLabel(value: string): string {
  ...
  const labels: Record<string, string> = {
    OBJECT_TYPE_NOT_ALLOWED: '当前内容合集不包含此类内容', EVIDENCE_REQUIRED: '缺少可核对的原文依据',
    ...
    RIGHTS_REFERENCE_MISSING: '还没有找到使用权利记录', RIGHTS_NOT_USABLE: '当前使用权利不可用'
  };
...
export function auditSubjectLabel(value: string): string { return auditSubjectLabels[value] || `系统记录（${value}）`; }
