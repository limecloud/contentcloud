...
//go:embed plugins/contentcloud-video-production plugins/contentcloud-wechat-article
var agentPlugins embed.FS

func AgentPlugin(name string) (fs.FS, error) {
	if name != "contentcloud-video-production" && name != "contentcloud-wechat-article" {
