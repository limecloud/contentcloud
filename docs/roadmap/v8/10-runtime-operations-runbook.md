...
> 本手册面向平台运维和支持人员，定义 Runtime Infra V2 的健康检查、准入灰度、排空、故障处置和回退边界。它以当前代码、迁移 `00035`、`00037`～`00043`、`00049`～`00051` 和 `/api/v1/admin/runtime-health` 为事实源。Desktop 只显示用户可理解的任务摘要；设备、Daemon、租约和 Runtime 诊断仍由本手册与 Web Operations 控制面负责。
