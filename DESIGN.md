...
- `web/src/marketing/marketing.css` 中当前首页是品牌视觉基准。首页保留自然光创作空间作为全幅底层背景，并在其上叠加可维护的产品工作画布，直接表达资料、资产、创作任务、确认和交付关系；登录注册继续复用同一场景资产。
...
- Hero 仍保持品牌优先、单一 CTA 组和下一段露出；产品画布只能在标题安全区之外承载资料、资产、任务和结果关系。
- 首页紧接客户创作台、资产目录、资产复用闭环和平台分层架构，视觉内容必须来自产品文档与当前代码事实。
...
- 产品介绍使用“创作输入与已有资产 -> Content Work OS 创作任务 -> 创作结果与专业工具”的三段式叙事。
