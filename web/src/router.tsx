...
export const appRoutes: RouteObject[] = [
  ...
  protectedStudioRoute('/studio', [
    ...
    {path: 'assets/materials/:materialID', lazy: async()=>({Component:(await import('./studio/StudioAssetDetailPage')).StudioMaterialDetailPage})},
    {path: 'assets/results/:taskID/:resultID', lazy: async()=>({Component:(await import('./studio/StudioAssetDetailPage')).StudioCreativeResultDetailPage})},
