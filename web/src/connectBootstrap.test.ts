...
describe('ContentCloud Agent bootstrap',()=>{
  ...
  it('provides fixed preflight, plan, resume, and diagnostic commands',()=>{
    ...
    expect(commands.preflight).toBe("npx --yes @limecloud/contentcloud@0.15.0 bootstrap preflight . --server-url 'https://content.example.com' --json");
