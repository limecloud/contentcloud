...
export function PublicReviewView({token}:{token:string}) {
  ...
  if(done)return <main className="public-page"><section className="public-panel"><div className="public-success"><CheckCircle2 size={28}/></div><h1>{done==='approve'?'内容已批准':'修改意见已提交'}</h1><p>本次决定已绑定到该内容版本的摘要，并写入审计记录。</p></section></main>;
