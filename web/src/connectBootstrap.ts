...
export const CONTENTCLOUD_CLI='npx --yes @limecloud/contentcloud@0.27.0';
...
const stageNames:Record<string,string>={
  ...
  plan_ready:'准备变更计划',awaiting_confirmation:'等待确认',plugin_installing:'安装 Content Work OS 插件',authorizing:'确认这台电脑',
